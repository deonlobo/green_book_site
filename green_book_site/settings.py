"""
Django settings for green_book_site project.
...
SECRET_KEY = 'django-insecure-oo^^9%bmhlwukao@gd+3yo!t2ajr1g10le-cl=%3wq9a!j#u4-'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'producesyncauth@gmail.com'
EMAIL_HOST_PASSWORD = 'qdpxnkfolpvwokhm'
DEFAULT_FROM_EMAIL = 'producesyncauth@gmail.com'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'marketplace.context_processors.products_processor'
            ],
        },
    },
]
