...
def feedView(request):
    ...
    return render(request, 'DIYProject/feed.html',
                  {'projects': projects, 'SearchForm': SearchForm, 'fav_projects': fav_projects,
...
def projectView(request, id):
    ...
    return render(request, 'DIYProject/view_project.html',
                  {'project': project, 'thoughts': thoughts, 'ThoughtForm': tf})
...
def bookmarkView(request):
    ...
    visit_history = request.session.get('visit_history', [])
    return render(request, 'DIYProject/feed.html',
                  {'projects': AllProjects, 'SearchForm': SearchForm, 'fav_projects': AllProjects,
                   'suggestions': visit_history[-5:]})
